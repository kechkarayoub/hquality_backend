...
from utils.utils import (
    get_establishments_types_dict, get_establishments_types, get_establishments_users_accounts_types,
    get_establishments_users_accounts_types_dict, get_gender_choices, get_gender_choices_dict,
    get_random_bg_color
)
import datetime
import uuid
...
class Establishment(models.Model):
    ...
    """
    class Meta(object):
        db_table = "hquality_establishment"
        ordering = ["name"]
        verbose_name = _("Establishment")
        verbose_name_plural = _("Establishments")
        unique_together = ('name', 'type',)

    TYPES = get_establishments_types()
    TYPES_DICT = get_establishments_types_dict()
...
class EstablishmentUser(models.Model):
    ...
    """
    class Meta(object):
        db_table = "hquality_establishment_user"
    ...
    ACCOUNT_TYPES = get_establishments_users_accounts_types()
    ACCOUNT_TYPES_DICT = get_establishments_users_accounts_types_dict()
    GENDERS = get_gender_choices()
    GENDERS_DICT = get_gender_choices_dict()
...
class UserEmailConfirmationKey(models.Model):
    ...
    """
    class Meta(object):
        db_table = "hquality_user_email_confirmation_key"
